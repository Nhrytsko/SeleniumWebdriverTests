...
public class MainPageTestSuite extends TestBase {
    ...
    public void classSetUp(String hub, String browserName, String port){
        this.mainPage = WebPageBase.startBrowser(hub, browserName, port).goToStartPage().logInAs(ConfigProvider.getValidUserName(), ConfigProvider.getValidUserPassword()).proceedWithMainPage();
